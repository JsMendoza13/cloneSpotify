/* empty css                           */import { e as createAstro, f as createComponent, r as renderTemplate, m as maybeRenderHead, g as addAttribute, h as renderSlot, i as renderComponent, j as renderHead, k as renderTransition } from '../astro_cacb00bf.mjs';
import 'html-escaper';
import cn from 'clsx';
...
const CurrentSong = ({ image, title, artists }) => {
  return /* @__PURE__ */ jsxs("div", { className: ` flex items-center gap-5 relative overflow-hidden`, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
      /* @__PURE__ */ jsxs("h3", { className: "font-semibold text-sm block", children: [
        " ",
        title
      ] }),
...
function Player() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-row justify-between w-full px-1 z-50", children: [
    /* @__PURE__ */ jsx("div", { className: "w-[200]", children: /* @__PURE__ */ jsx(CurrentSong, { ...currentMusic.song }) }),
    /* @__PURE__ */ jsxs("div", { className: "grid place-content-center gap-4 flex-1", children: [
      " ",
      /* @__PURE__ */ jsxs("div", { className: "flex justify-center flex-col items-center", children: [
...
}, "C:/Users/Js/Desktop/Portafolio/cloneSpotify/certain-comet/src/icons/Library.astro", void 0);
...
}, "C:/Users/Js/Desktop/Portafolio/cloneSpotify/certain-comet/src/icons/Home.astro", void 0);
...
}, "C:/Users/Js/Desktop/Portafolio/cloneSpotify/certain-comet/src/icons/Search.astro", void 0);
...
}, "C:/Users/Js/Desktop/Portafolio/cloneSpotify/certain-comet/src/components/SideMenuItem.astro", void 0);
...
}, "C:/Users/Js/Desktop/Portafolio/cloneSpotify/certain-comet/src/components/SideMenuCard.astro", void 0);
...
}, "C:/Users/Js/Desktop/Portafolio/cloneSpotify/certain-comet/src/components/AsideMenu.astro", void 0);
...
}, "C:/Users/Js/Desktop/Portafolio/cloneSpotify/certain-comet/node_modules/astro/components/ViewTransitions.astro", void 0);
...
}, "C:/Users/Js/Desktop/Portafolio/cloneSpotify/certain-comet/src/layouts/Layout.astro", "self");
...
}, "C:/Users/Js/Desktop/Portafolio/cloneSpotify/certain-comet/src/icons/Time.astro", void 0);
...
const $$MusicTable = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<table class="table-auto text-left min-w-full divide-y divide-gray-500/20"> <thead class=""> <tr class="text-zinc-400 text-sm"> <th class="px-4 py-2 font-light">#</th> <th class="px-4 py-2 font-light">Titulo</th> <th class="px-4 py-2 font-light">Álbum</th> <th class="px-4 py-2 font-light">${renderComponent($$result, "Time", $$Time, {})}</th> </tr> </thead> <tbody> <tr class="h-[16px]"></tr> ${songs.map((song, index) => renderTemplate`<tr class="border-spacing-0 text-gray-300 text-sm font-light hover:bg-white/10 overflow-hidden transition duration-300"> <td class="px-4 py-2 rounded-tl-lg rounded-bl-lg w-5">${index + 1}</td> <td class="px-4 py-2 flex gap-3"> <picture> <img class="w-11 h-11 "${addAttribute(song.image, "src")}${addAttribute(song.title, "alt")}> </picture> <div class="flex flex-col"> <h3 class="text-white text-base font-normal">${song.title}</h3> <span>${song.artists.join(", ")}</span> </div> </td> <td class="px-4 py-2">${song.album}</td> <td class="px-4 py-2 rounded-tr-lg rounded-br-lg">${song.duration}</td> </tr>`)} </tbody> </table>`;
}, "C:/Users/Js/Desktop/Portafolio/cloneSpotify/certain-comet/src/components/MusicTable.astro", void 0);
...
const $$id = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Spotify clone." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div id="playlist-container" class="relative flex flex-col h-full bg-zinc-900 overflow-x-hidden"${addAttribute(renderTransition($$result2, "lwbbxtwc", "", `playlist ${id} box`), "data-astro-transition-scope")}> <header class="flex flex-row gap-8 px-6 mt-12"> <picture class="aspect-square w-52 h-52 flex-none"> <img${addAttribute(playlist?.cover, "src")}${addAttribute(`Cover of ${playlist?.title}`, "alt")} class="object-cover w-full h-full shadow-lg-"${addAttribute(renderTransition($$result2, "447rgqct", "", `playlist ${playlist?.id} image`), "data-astro-transition-scope")}> </picture> <div class="flex flex-col justify-between"> <h2 class="flex flex-1 items-end">Playlist</h2> <div> <h1 class="text-5xl font-bold block text-white"> ${playlist?.title} <span${addAttribute(renderTransition($$result2, "xqvi2465", "", `playlist ${playlist?.id} title`), "data-astro-transition-scope")}></span> </h1> </div> <div class="flex-1 flex items-end"> <div class="text-sm text-gray-300 font-normal"> <div${addAttribute(renderTransition($$result2, "5hvgcehm", "", `playlist ${playlist?.id} artists`), "data-astro-transition-scope")}> <span>${playlist?.artists.join(", ")}</span> </div> <p class="mt-1"> <span class="text-white">${playListSongs.length} canciones</span>,
              3 h aproximadamente
</p> </div> </div> </div> </header> <div class="pl-6 pt-6"> ${renderComponent($$result2, "CardPlayButton", CardPlayButton, { "id": id, "client:load": true, "size": "large", "client:component-hydration": "load", "client:component-path": "@/components/CardPlayButton", "client:component-export": "CardPlayButton" })} </div> <div class="relative z-10 px-6 pt-10"></div> <div class="absolute inset-0 bg-gradient-to-t from-zinc-900 via-zinc-900/80 -z-[1]"></div> <section class="p-6"> ${renderComponent($$result2, "MusicTable", $$MusicTable, { "songs": playListSongs })} </section> </div> ` })}`;
}, "C:/Users/Js/Desktop/Portafolio/cloneSpotify/certain-comet/src/pages/playlist/[id].astro", "self");

const $$file = "C:/Users/Js/Desktop/Portafolio/cloneSpotify/certain-comet/src/pages/playlist/[id].astro";
